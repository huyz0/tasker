...
- **Task**: M10-T03 done — M10-T04 (`can(principal, scope, permission)` in
  `lib/policy.ts`) is next
...
| M10 | Teams & Policy-Based RBAC      | in-progress | M03, M04 | 13  | 3    |
...
**Total: 160 tasks across 13 milestones — 107 done (M01 14, M02 7, M03 16, M04 12, M05 12, M06 14, M07 14, M10 3, M13 15).**
