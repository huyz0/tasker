...
- **Task**: M10-T04 done — M10-T05 (replace every `assertOrg*` call site
  with a `can` check) is next
...
| M10 | Teams & Policy-Based RBAC      | in-progress | M03, M04 | 13  | 4    |
...
**Total: 160 tasks across 13 milestones — 108 done (M01 14, M02 7, M03 16, M04 12, M05 12, M06 14, M07 14, M10 4, M13 15).**
