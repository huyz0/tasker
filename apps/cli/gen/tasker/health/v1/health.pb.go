...
var file_tasker_health_v1_health_proto_rawDesc = []byte{
	...
	0x61, 0x73, 0x6b, 0x65, 0x72, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x2e,
	0x54, 0x61, 0x73, 0x6b, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x4c, 0x69, 0x6e, 0x6b,
	0x52, 0x04, 0x6c, 0x69, 0x6e, 0x6b, 0x22, 0x32, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x72,
	...
	0x52, 0x08, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x49, 0x64, 0x22, 0x51, 0x0a, 0x15, 0x4c, 0x69,
	...
	0x63, 0x74, 0x52, 0x09, 0x61, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63, 0x74, 0x73, 0x22, 0x32, 0x0a,
	...
	0x64, 0x22, 0x49, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x73,
	...
	0x64, 0x65, 0x72, 0x52, 0x07, 0x66, 0x6f, 0x6c, 0x64, 0x65, 0x72, 0x73, 0x22, 0xbf, 0x01, 0x0a,
	...
	0x65, 0x32, 0x80, 0x03, 0x0a, 0x0b, 0x54, 0x61, 0x73, 0x6b, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xfe, 0x03, 0x0a, 0x0f, 0x41, 0x72, 0x74, 0x69, 0x66, 0x61, 0x63,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd1, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	...
	0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd8, 0x01, 0x0a, 0x0f, 0x54, 0x61,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x32, 0xe0, 0x02, 0x0a, 0x11, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74,
...
var file_tasker_health_v1_health_proto_depIdxs = []int32{
	...
	41, // 20: tasker.health.v1.UpdateTaskStatusResponse.task:type_name -> tasker.health.v1.Task
	52, // 21: tasker.health.v1.CreateFolderResponse.folder:type_name -> tasker.health.v1.Folder
	53, // 22: tasker.health.v1.CreateArtifactResponse.artifact:type_name -> tasker.health.v1.Artifact
	54, // 23: tasker.health.v1.LinkTaskArtifactResponse.link:type_name -> tasker.health.v1.TaskArtifactLink
	53, // 24: tasker.health.v1.ListArtifactsResponse.artifacts:type_name -> tasker.health.v1.Artifact
	52, // 25: tasker.health.v1.ListFoldersResponse.folders:type_name -> tasker.health.v1.Folder
	65, // 26: tasker.health.v1.CreateCommentResponse.comment:type_name -> tasker.health.v1.Comment
	65, // 27: tasker.health.v1.ListCommentsResponse.comments:type_name -> tasker.health.v1.Comment
	70, // 28: tasker.health.v1.CreateTaskNoteResponse.taskNote:type_name -> tasker.health.v1.TaskNote
	70, // 29: tasker.health.v1.ListTaskNotesResponse.taskNotes:type_name -> tasker.health.v1.TaskNote
	75, // 30: tasker.health.v1.AddRepositoryLinkResponse.link:type_name -> tasker.health.v1.RepositoryLink
	75, // 31: tasker.health.v1.ListRepositoryLinksResponse.links:type_name -> tasker.health.v1.RepositoryLink
	83, // 32: tasker.health.v1.UniversalSearchResponse.results:type_name -> tasker.health.v1.SearchResult
	0,  // 33: tasker.health.v1.HealthService.Ping:input_type -> tasker.health.v1.PingRequest
	4,  // 34: tasker.health.v1.AuthService.GetIdentity:input_type -> tasker.health.v1.GetIdentityRequest
	6,  // 35: tasker.health.v1.OrgService.ListOrgs:input_type -> tasker.health.v1.ListOrgsRequest
	8,  // 36: tasker.health.v1.OrgService.SeedOrg:input_type -> tasker.health.v1.SeedOrgRequest
	10, // 37: tasker.health.v1.OrgService.InviteUser:input_type -> tasker.health.v1.InviteUserRequest
	15, // 38: tasker.health.v1.TaskTypeService.GetTaskType:input_type -> tasker.health.v1.GetTaskTypeRequest
	17, // 39: tasker.health.v1.TaskTypeService.CreateTaskType:input_type -> tasker.health.v1.CreateTaskTypeRequest
	21, // 40: tasker.health.v1.ProjectTemplateService.GetTemplate:input_type -> tasker.health.v1.GetProjectTemplateRequest
	23, // 41: tasker.health.v1.ProjectTemplateService.CreateTemplate:input_type -> tasker.health.v1.CreateProjectTemplateRequest
	25, // 42: tasker.health.v1.ProjectTemplateService.ListTemplates:input_type -> tasker.health.v1.ListProjectTemplatesRequest
	27, // 43: tasker.health.v1.ProjectService.GetProject:input_type -> tasker.health.v1.GetProjectRequest
	29, // 44: tasker.health.v1.ProjectService.CreateProject:input_type -> tasker.health.v1.CreateProjectRequest
	31, // 45: tasker.health.v1.ProjectService.ListProjects:input_type -> tasker.health.v1.ListProjectsRequest
	35, // 46: tasker.health.v1.AgentService.CreateAgentRole:input_type -> tasker.health.v1.CreateAgentRoleRequest
	37, // 47: tasker.health.v1.AgentService.CreateAgent:input_type -> tasker.health.v1.CreateAgentRequest
	39, // 48: tasker.health.v1.AgentService.ListAgents:input_type -> tasker.health.v1.ListAgentsRequest
	42, // 49: tasker.health.v1.TaskService.CreateTask:input_type -> tasker.health.v1.CreateTaskRequest
	44, // 50: tasker.health.v1.TaskService.AssignTask:input_type -> tasker.health.v1.AssignTaskRequest
	48, // 51: tasker.health.v1.TaskService.ListTasks:input_type -> tasker.health.v1.ListTasksRequest
	50, // 52: tasker.health.v1.TaskService.UpdateTaskStatus:input_type -> tasker.health.v1.UpdateTaskStatusRequest
	55, // 53: tasker.health.v1.ArtifactService.CreateFolder:input_type -> tasker.health.v1.CreateFolderRequest
	57, // 54: tasker.health.v1.ArtifactService.CreateArtifact:input_type -> tasker.health.v1.CreateArtifactRequest
	59, // 55: tasker.health.v1.ArtifactService.LinkTaskArtifact:input_type -> tasker.health.v1.LinkTaskArtifactRequest
	61, // 56: tasker.health.v1.ArtifactService.ListArtifacts:input_type -> tasker.health.v1.ListArtifactsRequest
	63, // 57: tasker.health.v1.ArtifactService.ListFolders:input_type -> tasker.health.v1.ListFoldersRequest
	66, // 58: tasker.health.v1.CommentService.CreateComment:input_type -> tasker.health.v1.CreateCommentRequest
	68, // 59: tasker.health.v1.CommentService.ListComments:input_type -> tasker.health.v1.ListCommentsRequest
	71, // 60: tasker.health.v1.TaskNoteService.CreateTaskNote:input_type -> tasker.health.v1.CreateTaskNoteRequest
	73, // 61: tasker.health.v1.TaskNoteService.ListTaskNotes:input_type -> tasker.health.v1.ListTaskNotesRequest
	77, // 62: tasker.health.v1.RepositoryService.AddRepositoryLink:input_type -> tasker.health.v1.AddRepositoryLinkRequest
	79, // 63: tasker.health.v1.RepositoryService.ListRepositoryLinks:input_type -> tasker.health.v1.ListRepositoryLinksRequest
	81, // 64: tasker.health.v1.RepositoryService.SyncPullRequests:input_type -> tasker.health.v1.SyncPullRequestsRequest
	84, // 65: tasker.health.v1.SearchService.UniversalSearch:input_type -> tasker.health.v1.UniversalSearchRequest
	1,  // 66: tasker.health.v1.HealthService.Ping:output_type -> tasker.health.v1.PingResponse
	5,  // 67: tasker.health.v1.AuthService.GetIdentity:output_type -> tasker.health.v1.GetIdentityResponse
	7,  // 68: tasker.health.v1.OrgService.ListOrgs:output_type -> tasker.health.v1.ListOrgsResponse
	9,  // 69: tasker.health.v1.OrgService.SeedOrg:output_type -> tasker.health.v1.SeedOrgResponse
	11, // 70: tasker.health.v1.OrgService.InviteUser:output_type -> tasker.health.v1.InviteUserResponse
	16, // 71: tasker.health.v1.TaskTypeService.GetTaskType:output_type -> tasker.health.v1.GetTaskTypeResponse
	18, // 72: tasker.health.v1.TaskTypeService.CreateTaskType:output_type -> tasker.health.v1.CreateTaskTypeResponse
	22, // 73: tasker.health.v1.ProjectTemplateService.GetTemplate:output_type -> tasker.health.v1.GetProjectTemplateResponse
	24, // 74: tasker.health.v1.ProjectTemplateService.CreateTemplate:output_type -> tasker.health.v1.CreateProjectTemplateResponse
	26, // 75: tasker.health.v1.ProjectTemplateService.ListTemplates:output_type -> tasker.health.v1.ListProjectTemplatesResponse
	28, // 76: tasker.health.v1.ProjectService.GetProject:output_type -> tasker.health.v1.GetProjectResponse
	30, // 77: tasker.health.v1.ProjectService.CreateProject:output_type -> tasker.health.v1.CreateProjectResponse
	32, // 78: tasker.health.v1.ProjectService.ListProjects:output_type -> tasker.health.v1.ListProjectsResponse
	36, // 79: tasker.health.v1.AgentService.CreateAgentRole:output_type -> tasker.health.v1.CreateAgentRoleResponse
	38, // 80: tasker.health.v1.AgentService.CreateAgent:output_type -> tasker.health.v1.CreateAgentResponse
	40, // 81: tasker.health.v1.AgentService.ListAgents:output_type -> tasker.health.v1.ListAgentsResponse
	43, // 82: tasker.health.v1.TaskService.CreateTask:output_type -> tasker.health.v1.CreateTaskResponse
	45, // 83: tasker.health.v1.TaskService.AssignTask:output_type -> tasker.health.v1.AssignTaskResponse
	49, // 84: tasker.health.v1.TaskService.ListTasks:output_type -> tasker.health.v1.ListTasksResponse
	51, // 85: tasker.health.v1.TaskService.UpdateTaskStatus:output_type -> tasker.health.v1.UpdateTaskStatusResponse
	56, // 86: tasker.health.v1.ArtifactService.CreateFolder:output_type -> tasker.health.v1.CreateFolderResponse
	58, // 87: tasker.health.v1.ArtifactService.CreateArtifact:output_type -> tasker.health.v1.CreateArtifactResponse
	60, // 88: tasker.health.v1.ArtifactService.LinkTaskArtifact:output_type -> tasker.health.v1.LinkTaskArtifactResponse
	62, // 89: tasker.health.v1.ArtifactService.ListArtifacts:output_type -> tasker.health.v1.ListArtifactsResponse
	64, // 90: tasker.health.v1.ArtifactService.ListFolders:output_type -> tasker.health.v1.ListFoldersResponse
	67, // 91: tasker.health.v1.CommentService.CreateComment:output_type -> tasker.health.v1.CreateCommentResponse
	69, // 92: tasker.health.v1.CommentService.ListComments:output_type -> tasker.health.v1.ListCommentsResponse
	72, // 93: tasker.health.v1.TaskNoteService.CreateTaskNote:output_type -> tasker.health.v1.CreateTaskNoteResponse
	74, // 94: tasker.health.v1.TaskNoteService.ListTaskNotes:output_type -> tasker.health.v1.ListTaskNotesResponse
	78, // 95: tasker.health.v1.RepositoryService.AddRepositoryLink:output_type -> tasker.health.v1.AddRepositoryLinkResponse
	80, // 96: tasker.health.v1.RepositoryService.ListRepositoryLinks:output_type -> tasker.health.v1.ListRepositoryLinksResponse
	82, // 97: tasker.health.v1.RepositoryService.SyncPullRequests:output_type -> tasker.health.v1.SyncPullRequestsResponse
	85, // 98: tasker.health.v1.SearchService.UniversalSearch:output_type -> tasker.health.v1.UniversalSearchResponse
