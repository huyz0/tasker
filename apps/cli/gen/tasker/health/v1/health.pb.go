...
var file_tasker_health_v1_health_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0x56, 0x0a, 0x0d, 0x48,
	...
	0x6e, 0x73, 0x65, 0x32, 0xd2, 0x01, 0x0a, 0x0c, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72,
	...
	0x68, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x41, 0x67, 0x65, 0x6e, 0x74,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xbf, 0x01, 0x0a, 0x0b, 0x54, 0x61, 0x73,
	...
	0x73, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xfe, 0x03, 0x0a, 0x0f, 0x41,
	...
	0x65, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xd1, 0x01, 0x0a, 0x0e,
	...
	0x75, 0x65, 0x73, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x37, 0x5a,
...
var file_tasker_health_v1_health_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
...
var file_tasker_health_v1_health_proto_depIdxs = []int32{
	...
	0,  // 27: tasker.health.v1.HealthService.Ping:input_type -> tasker.health.v1.PingRequest
	4,  // 28: tasker.health.v1.AuthService.GetIdentity:input_type -> tasker.health.v1.GetIdentityRequest
	6,  // 29: tasker.health.v1.OrgService.ListOrgs:input_type -> tasker.health.v1.ListOrgsRequest
	8,  // 30: tasker.health.v1.OrgService.SeedOrg:input_type -> tasker.health.v1.SeedOrgRequest
	10, // 31: tasker.health.v1.OrgService.InviteUser:input_type -> tasker.health.v1.InviteUserRequest
	15, // 32: tasker.health.v1.TaskTypeService.GetTaskType:input_type -> tasker.health.v1.GetTaskTypeRequest
	17, // 33: tasker.health.v1.TaskTypeService.CreateTaskType:input_type -> tasker.health.v1.CreateTaskTypeRequest
	21, // 34: tasker.health.v1.ProjectTemplateService.GetTemplate:input_type -> tasker.health.v1.GetProjectTemplateRequest
	23, // 35: tasker.health.v1.ProjectTemplateService.CreateTemplate:input_type -> tasker.health.v1.CreateProjectTemplateRequest
	25, // 36: tasker.health.v1.ProjectTemplateService.ListTemplates:input_type -> tasker.health.v1.ListProjectTemplatesRequest
	27, // 37: tasker.health.v1.ProjectService.GetProject:input_type -> tasker.health.v1.GetProjectRequest
	29, // 38: tasker.health.v1.ProjectService.CreateProject:input_type -> tasker.health.v1.CreateProjectRequest
	31, // 39: tasker.health.v1.ProjectService.ListProjects:input_type -> tasker.health.v1.ListProjectsRequest
	35, // 40: tasker.health.v1.AgentService.CreateAgentRole:input_type -> tasker.health.v1.CreateAgentRoleRequest
	37, // 41: tasker.health.v1.AgentService.CreateAgent:input_type -> tasker.health.v1.CreateAgentRequest
	40, // 42: tasker.health.v1.TaskService.CreateTask:input_type -> tasker.health.v1.CreateTaskRequest
	42, // 43: tasker.health.v1.TaskService.AssignTask:input_type -> tasker.health.v1.AssignTaskRequest
	47, // 44: tasker.health.v1.ArtifactService.CreateFolder:input_type -> tasker.health.v1.CreateFolderRequest
	49, // 45: tasker.health.v1.ArtifactService.CreateArtifact:input_type -> tasker.health.v1.CreateArtifactRequest
	51, // 46: tasker.health.v1.ArtifactService.LinkTaskArtifact:input_type -> tasker.health.v1.LinkTaskArtifactRequest
	53, // 47: tasker.health.v1.ArtifactService.ListArtifacts:input_type -> tasker.health.v1.ListArtifactsRequest
	55, // 48: tasker.health.v1.ArtifactService.ListFolders:input_type -> tasker.health.v1.ListFoldersRequest
	58, // 49: tasker.health.v1.CommentService.CreateComment:input_type -> tasker.health.v1.CreateCommentRequest
	60, // 50: tasker.health.v1.CommentService.ListComments:input_type -> tasker.health.v1.ListCommentsRequest
	63, // 51: tasker.health.v1.TaskNoteService.CreateTaskNote:input_type -> tasker.health.v1.CreateTaskNoteRequest
	65, // 52: tasker.health.v1.TaskNoteService.ListTaskNotes:input_type -> tasker.health.v1.ListTaskNotesRequest
	69, // 53: tasker.health.v1.RepositoryService.AddRepositoryLink:input_type -> tasker.health.v1.AddRepositoryLinkRequest
	71, // 54: tasker.health.v1.RepositoryService.ListRepositoryLinks:input_type -> tasker.health.v1.ListRepositoryLinksRequest
	73, // 55: tasker.health.v1.RepositoryService.SyncPullRequests:input_type -> tasker.health.v1.SyncPullRequestsRequest
	1,  // 56: tasker.health.v1.HealthService.Ping:output_type -> tasker.health.v1.PingResponse
	5,  // 57: tasker.health.v1.AuthService.GetIdentity:output_type -> tasker.health.v1.GetIdentityResponse
	7,  // 58: tasker.health.v1.OrgService.ListOrgs:output_type -> tasker.health.v1.ListOrgsResponse
	9,  // 59: tasker.health.v1.OrgService.SeedOrg:output_type -> tasker.health.v1.SeedOrgResponse
	11, // 60: tasker.health.v1.OrgService.InviteUser:output_type -> tasker.health.v1.InviteUserResponse
	16, // 61: tasker.health.v1.TaskTypeService.GetTaskType:output_type -> tasker.health.v1.GetTaskTypeResponse
	18, // 62: tasker.health.v1.TaskTypeService.CreateTaskType:output_type -> tasker.health.v1.CreateTaskTypeResponse
	22, // 63: tasker.health.v1.ProjectTemplateService.GetTemplate:output_type -> tasker.health.v1.GetProjectTemplateResponse
	24, // 64: tasker.health.v1.ProjectTemplateService.CreateTemplate:output_type -> tasker.health.v1.CreateProjectTemplateResponse
	26, // 65: tasker.health.v1.ProjectTemplateService.ListTemplates:output_type -> tasker.health.v1.ListProjectTemplatesResponse
	28, // 66: tasker.health.v1.ProjectService.GetProject:output_type -> tasker.health.v1.GetProjectResponse
	30, // 67: tasker.health.v1.ProjectService.CreateProject:output_type -> tasker.health.v1.CreateProjectResponse
	32, // 68: tasker.health.v1.ProjectService.ListProjects:output_type -> tasker.health.v1.ListProjectsResponse
	36, // 69: tasker.health.v1.AgentService.CreateAgentRole:output_type -> tasker.health.v1.CreateAgentRoleResponse
	38, // 70: tasker.health.v1.AgentService.CreateAgent:output_type -> tasker.health.v1.CreateAgentResponse
	41, // 71: tasker.health.v1.TaskService.CreateTask:output_type -> tasker.health.v1.CreateTaskResponse
	43, // 72: tasker.health.v1.TaskService.AssignTask:output_type -> tasker.health.v1.AssignTaskResponse
	48, // 73: tasker.health.v1.ArtifactService.CreateFolder:output_type -> tasker.health.v1.CreateFolderResponse
	50, // 74: tasker.health.v1.ArtifactService.CreateArtifact:output_type -> tasker.health.v1.CreateArtifactResponse
	52, // 75: tasker.health.v1.ArtifactService.LinkTaskArtifact:output_type -> tasker.health.v1.LinkTaskArtifactResponse
	54, // 76: tasker.health.v1.ArtifactService.ListArtifacts:output_type -> tasker.health.v1.ListArtifactsResponse
	56, // 77: tasker.health.v1.ArtifactService.ListFolders:output_type -> tasker.health.v1.ListFoldersResponse
	59, // 78: tasker.health.v1.CommentService.CreateComment:output_type -> tasker.health.v1.CreateCommentResponse
	61, // 79: tasker.health.v1.CommentService.ListComments:output_type -> tasker.health.v1.ListCommentsResponse
	64, // 80: tasker.health.v1.TaskNoteService.CreateTaskNote:output_type -> tasker.health.v1.CreateTaskNoteResponse
	66, // 81: tasker.health.v1.TaskNoteService.ListTaskNotes:output_type -> tasker.health.v1.ListTaskNotesResponse
	70, // 82: tasker.health.v1.RepositoryService.AddRepositoryLink:output_type -> tasker.health.v1.AddRepositoryLinkResponse
	72, // 83: tasker.health.v1.RepositoryService.ListRepositoryLinks:output_type -> tasker.health.v1.ListRepositoryLinksResponse
	74, // 84: tasker.health.v1.RepositoryService.SyncPullRequests:output_type -> tasker.health.v1.SyncPullRequestsResponse
