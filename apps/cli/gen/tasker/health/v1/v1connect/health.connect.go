...
const (
	...
	AuthServiceListLinkedIdentitiesProcedure = "/tasker.health.v1.AuthService/ListLinkedIdentities"
	...
	// ArtifactServiceUpdateArtifactContentProcedure is the fully-qualified name of the
	// ArtifactService's UpdateArtifactContent RPC.
	ArtifactServiceUpdateArtifactContentProcedure = "/tasker.health.v1.ArtifactService/UpdateArtifactContent"
	...
	// ArtifactServiceUnlinkTaskArtifactProcedure is the fully-qualified name of the ArtifactService's
	// UnlinkTaskArtifact RPC.
	ArtifactServiceUnlinkTaskArtifactProcedure = "/tasker.health.v1.ArtifactService/UnlinkTaskArtifact"
	// ArtifactServiceListTaskArtifactLinksProcedure is the fully-qualified name of the
	// ArtifactService's ListTaskArtifactLinks RPC.
	ArtifactServiceListTaskArtifactLinksProcedure = "/tasker.health.v1.ArtifactService/ListTaskArtifactLinks"
	...
	// GetArtifact RPC.
	ArtifactServiceGetArtifactProcedure = "/tasker.health.v1.ArtifactService/GetArtifact"
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	return &authServiceClient{
		...
		listLinkedIdentities: connect.NewClient[v1.ListLinkedIdentitiesRequest, v1.ListLinkedIdentitiesResponse](
			...
			connect.WithSchema(authServiceListLinkedIdentitiesMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
// ListLinkedIdentities calls tasker.health.v1.AuthService.ListLinkedIdentities.
...
// UnlinkIdentity calls tasker.health.v1.AuthService.UnlinkIdentity.
...
func (UnimplementedAuthServiceHandler) ListLinkedIdentities(context.Context, *connect.Request[v1.ListLinkedIdentitiesRequest]) (*connect.Response[v1.ListLinkedIdentitiesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tasker.health.v1.AuthService.ListLinkedIdentities is not implemented"))
}
...
func NewArtifactServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ArtifactServiceClient {
	...
	return &artifactServiceClient{
		...
		updateArtifactContent: connect.NewClient[v1.UpdateArtifactContentRequest, v1.UpdateArtifactContentResponse](
			httpClient,
			baseURL+ArtifactServiceUpdateArtifactContentProcedure,
			connect.WithSchema(artifactServiceUpdateArtifactContentMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		...
		unlinkTaskArtifact: connect.NewClient[v1.UnlinkTaskArtifactRequest, v1.UnlinkTaskArtifactResponse](
			httpClient,
			baseURL+ArtifactServiceUnlinkTaskArtifactProcedure,
			connect.WithSchema(artifactServiceUnlinkTaskArtifactMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
		listTaskArtifactLinks: connect.NewClient[v1.ListTaskArtifactLinksRequest, v1.ListTaskArtifactLinksResponse](
			httpClient,
			baseURL+ArtifactServiceListTaskArtifactLinksProcedure,
			connect.WithSchema(artifactServiceListTaskArtifactLinksMethodDescriptor),
			connect.WithClientOptions(opts...),
		),
...
// UpdateArtifactContent calls tasker.health.v1.ArtifactService.UpdateArtifactContent.
func (c *artifactServiceClient) UpdateArtifactContent(ctx context.Context, req *connect.Request[v1.UpdateArtifactContentRequest]) (*connect.Response[v1.UpdateArtifactContentResponse], error) {
	return c.updateArtifactContent.CallUnary(ctx, req)
}
...
// UnlinkTaskArtifact calls tasker.health.v1.ArtifactService.UnlinkTaskArtifact.
func (c *artifactServiceClient) UnlinkTaskArtifact(ctx context.Context, req *connect.Request[v1.UnlinkTaskArtifactRequest]) (*connect.Response[v1.UnlinkTaskArtifactResponse], error) {
	return c.unlinkTaskArtifact.CallUnary(ctx, req)
}

// ListTaskArtifactLinks calls tasker.health.v1.ArtifactService.ListTaskArtifactLinks.
func (c *artifactServiceClient) ListTaskArtifactLinks(ctx context.Context, req *connect.Request[v1.ListTaskArtifactLinksRequest]) (*connect.Response[v1.ListTaskArtifactLinksResponse], error) {
	return c.listTaskArtifactLinks.CallUnary(ctx, req)
}
...
// GetArtifact calls tasker.health.v1.ArtifactService.GetArtifact.
...
func NewArtifactServiceHandler(svc ArtifactServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	artifactServiceUpdateArtifactContentHandler := connect.NewUnaryHandler(
		ArtifactServiceUpdateArtifactContentProcedure,
		svc.UpdateArtifactContent,
		connect.WithSchema(artifactServiceUpdateArtifactContentMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	artifactServiceUnlinkTaskArtifactHandler := connect.NewUnaryHandler(
		ArtifactServiceUnlinkTaskArtifactProcedure,
		svc.UnlinkTaskArtifact,
		connect.WithSchema(artifactServiceUnlinkTaskArtifactMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	artifactServiceListTaskArtifactLinksHandler := connect.NewUnaryHandler(
		ArtifactServiceListTaskArtifactLinksProcedure,
		svc.ListTaskArtifactLinks,
		connect.WithSchema(artifactServiceListTaskArtifactLinksMethodDescriptor),
		connect.WithHandlerOptions(opts...),
	)
	...
	return "/tasker.health.v1.ArtifactService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case ArtifactServiceUpdateArtifactContentProcedure:
			artifactServiceUpdateArtifactContentHandler.ServeHTTP(w, r)
		case ArtifactServiceLinkTaskArtifactProcedure:
			artifactServiceLinkTaskArtifactHandler.ServeHTTP(w, r)
		case ArtifactServiceUnlinkTaskArtifactProcedure:
			artifactServiceUnlinkTaskArtifactHandler.ServeHTTP(w, r)
		case ArtifactServiceListTaskArtifactLinksProcedure:
...
func (UnimplementedArtifactServiceHandler) UpdateArtifactContent(context.Context, *connect.Request[v1.UpdateArtifactContentRequest]) (*connect.Response[v1.UpdateArtifactContentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tasker.health.v1.ArtifactService.UpdateArtifactContent is not implemented"))
}
...
func (UnimplementedArtifactServiceHandler) UnlinkTaskArtifact(context.Context, *connect.Request[v1.UnlinkTaskArtifactRequest]) (*connect.Response[v1.UnlinkTaskArtifactResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tasker.health.v1.ArtifactService.UnlinkTaskArtifact is not implemented"))
}

func (UnimplementedArtifactServiceHandler) ListTaskArtifactLinks(context.Context, *connect.Request[v1.ListTaskArtifactLinksRequest]) (*connect.Response[v1.ListTaskArtifactLinksResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tasker.health.v1.ArtifactService.ListTaskArtifactLinks is not implemented"))
}
...
func (UnimplementedArtifactServiceHandler) GetArtifact(context.Context, *connect.Request[v1.GetArtifactRequest]) (*connect.Response[v1.GetArtifactResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("tasker.health.v1.ArtifactService.GetArtifact is not implemented"))
}
