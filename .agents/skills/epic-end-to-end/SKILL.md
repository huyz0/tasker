...
- DO NOT stop for human review between phases. Treat the execution of review skills in autonomous mode as sufficient approval to proceed to the next stage. Bypass interactive user review checkpoints normally found in sub-skills.
...
2. **Define Phase:** 
   - If given a topic, execute `epic-define` logic (refer to `.agents/skills/epic-define/SKILL.md`) in autonomous mode.
   - Ensure the `EPIC.md` is generated and fully task-broken down.
3. **Design Phase:** 
   - Execute `epic-design` logic (refer to `.agents/skills/epic-design/SKILL.md`) for the defined epic in autonomous mode.
   - Wait for Architecture, UX, and QA Plan generation to complete and populate.
4. **Design Review Phase:**
   - Execute `epic-design-review` logic (`.agents/skills/epic-design-review/SKILL.md`) in autonomous mode.
...
5. **Implementation Phase:**
   - Execute the implementation sequence (`.agents/skills/epic-implement/SKILL.md`) in autonomous mode.
...
6. **Post-Implementation Review Phase:**
   - Execute `epic-implement-review` logic (`.agents/skills/epic-implement-review/SKILL.md`) in autonomous mode.
