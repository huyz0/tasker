...
4. **Report:** Generate the review document at the configured `workflow.yml` path. Update `EPIC.md` `reviews.architecture_code` status. Ask if they want you to help fix the architectural drift.
