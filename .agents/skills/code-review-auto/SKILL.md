...
5. **Output Report:** Generate the review document at the configured `workflow.yml` path listing passes, specific file/line feedback, and the final decision. Update `EPIC.md` `reviews.code` status.
