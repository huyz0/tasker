...
3. **Analyze:** Verify the implemented source code for the epic. 
   ...
   - You MUST run `npx moon check --all` (to verify the code compiles) AND the `.agents/skills/local-ci-run/SKILL.md` workflow (to verify CI pipelines pass) locally securely in the terminal before approving.
