...
- **Side effects**: Make sure operations like publishing Domain Events via message brokers only happen *after* successful database commits to avoid phantom events being fired.
