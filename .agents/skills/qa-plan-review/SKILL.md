...
4. **Report:** Generate the review document at the configured `workflow.yml` path. Update `EPIC.md` `reviews.qa_plan` status. Ask if they want you to help add the missing scenarios.
