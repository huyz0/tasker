...
1. **Pre-flight**: resolve the ledger; ensure the council directory exists. Load
...
3. **Merge.** Dispatch one Moderator on the advanced-reasoning tier with all 8
   ...
   drops any candidate an open milestone already owns; delivery runs through
   `.milestones/`, and recommending planned work wastes the council.
...
6. **Write the report** to the council directory as
...
COUNCIL 0004 — 11 candidates, 8 advisors × 2 rounds
  ...
  Report:    .epics/council/COUNCIL-0004-2026-08-15T09-12-03.md
  Next:      /epic-run-auto "Repository Webhooks & Event Ingestion"
```
