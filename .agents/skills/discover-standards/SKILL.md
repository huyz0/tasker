...
description: Discover Standards
---
# Discover Standards
...
- **Write concise standards** — Use minimal words. Standards must be scannable by Antigravity and other AI agents without bloating context windows.
...
4. Create or update the file in `.specs/standards/[folder]/`
...
All standards: `.specs/standards/[folder]/[standard].md`
Index file: `.specs/standards/index.yml`
