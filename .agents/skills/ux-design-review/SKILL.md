...
4. **Report:** Generate the review document at the configured `workflow.yml` path and display findings. Update `EPIC.md` `reviews.ux` status. Ask if they want you to help fix or iterate on the designs.
