...
4. **Output Report:** Generate the review document at the configured `work-ledger.yml` path listing gaps in the test plan and required additions. Update `EPIC.md` `reviews.qa_plan` status.
