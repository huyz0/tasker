...
4. **Output Report:** Generate the review document at the configured `workflow.yml` path listing passes, violations, and required remediation steps. Update `EPIC.md` `reviews.architecture` status.
